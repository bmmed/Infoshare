    ...
    echo (' 
      ...
      <div class="contenaire_sup">
        <div class="slide_sup"> 
          ...
          <h2>Suprimer cette affichage</h2>
          <img src="../img/close.png">
        </div>
        <div class="box_sup">

          <h3>Voulez vous vraiment suprimer cette affichage ?</h3>
      ...
      <form method="post" action="./php_server_admin/sup_affi.php" class="form_sup">
       <input type="hidden" value="'.$affi_unit['aff_id'].'" name="sup_id" >
